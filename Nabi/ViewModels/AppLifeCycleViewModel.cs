										  ...
										  , IAppearanceManager appearance)
		{
			...
			try
			{
				...
				appearance.AddThemeResources("Generic", new List<Uri>
				{
					...
					,new Uri("/Nabi;component/BindToMLib/MWindowLib_DarkLightBrushs.xaml", UriKind.RelativeOrAbsolute)
			...
			try
			{
				...
				appearance.AddThemeResources("VS 2013 Blue", new List<Uri>
				{
				  ...
				  ,new Uri("/Nabi;component/BindToMLib/MWindowLib_DarkLightBrushs.xaml", UriKind.RelativeOrAbsolute)
				  ,new Uri("/Nabi;component/BindToMLib/AvalonDock_Dark_LightBrushs.xaml", UriKind.RelativeOrAbsolute)
			...
			try
			{
				...
				appearance.AddThemeResources("VS 2013 Dark", new List<Uri>
				{
				  ...
				  ,new Uri("/Nabi;component/BindToMLib/MWindowLib_DarkLightBrushs.xaml", UriKind.RelativeOrAbsolute)
				  ,new Uri("/Nabi;component/BindToMLib/AvalonDock_Dark_LightBrushs.xaml", UriKind.RelativeOrAbsolute)
				  ,new Uri("/Nabi;component/BindToMLib/ColorPickerLib_DarkLightBrushs.xaml", UriKind.RelativeOrAbsolute)
				  ,new Uri("/Nabi;component/BindToMLib/NumericUpDownLib_DarkLightBrushs.xaml", UriKind.RelativeOrAbsolute)
